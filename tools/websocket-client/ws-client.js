...
function uuidv4() {
    ...
    // SymBot's minimum Node.js version has crypto.randomUUID built in, so use it directly — no hand-rolled
    // fallback (which relied on the deprecated String.prototype.substr) is needed.
